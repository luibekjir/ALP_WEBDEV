...
<div class="w-full bg-[#F8D9DF] py-14 text-center">
    <h1 class="text-4xl font-bold text-[#5F1D2A]">Tentang Kami</h1>
...
<!-- Grid 3 × 2 seperti low-fi -->
<div class="w-full bg-[#FFF8F6]">
    <div class="container mx-auto py-12 grid grid-cols-1 md:grid-cols-3 gap-8 px-6">

        <!-- Visi -->
        <div class="bg-white border border-[#B8A5A8] p-6 rounded-xl shadow-sm">
        ...
        <div class="bg-white border border-[#B8A5A8] p-6 rounded-xl shadow-sm">
            ...
            <ul class="list-disc pl-5 text-[#5F1D2A]/80 space-y-1">
