...
@section('content')
    <div x-data="{ showAddAddressModal: false }">
                                ...
                                <div
                                    ...
                                    @if ($defaultAddress)
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Kel. {{ $defaultAddress->subdistrict_name }},
                                                Kec. {{ $defaultAddress->district_name }}
                                            </p>
                                        </div>
                ...
                <div class="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                    ...
                    <div class="p-6">
                        ...
                        <form action="{{ route('profile.update', $user) }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                <label for="email"
                                    class="block text-sm font-semibold text-[#5F1D2A] mb-2">Email</label>
        ...
        <!-- Add Address Modal -->
        <div x-show="showAddAddressModal" x-transition x-cloak class="fixed inset-0 bg-black bg-opacity-50 z-50">

            <div class="flex items-center justify-center min-h-screen p-4">
                <div x-data="addressForm()" x-init="fetchProvinces()"
                    ...
                    <div class="flex items-center justify-center min-h-screen p-4">
                        ...
                        <form action="{{ route('address.store') }}" method="POST"
                            ...
                            {{-- Provinsi --}}
                            <div>
                                <label for="province" class="block text-sm font-medium text-gray-700 mb-1">Provinsi
                                    Tujuan</label>
                                <select name="province" x-model="selectedProvince" @change="fetchCities()"
                            ...
                            <div>
                                ...
                                <select name="city" x-model="selectedCity" @change="fetchDistricts()"
                                    :disabled="cities.length === 0" required
                            ...
                            <div>
                                ...
                                <select name="subdistrict" x-model="selectedSubDistrict"
                            ...
                            <div class="flex gap-3 pt-4">
                                <button type="button" @click="showAddAddressModal = false"
            ...
            <script>
                ...
                function closeAddAddressModal() {
                    window.dispatchEvent(new CustomEvent('close-add-address'));
                    document.body.style.overflow = 'auto';
                }
