...
<head>
    ...
    <style>
        ...
        .login-card h1{ margin:0 0 12px 0; font-size:1.5rem; font-weight:600; color:#111827; }
        ...
        input[type="email"],
        input[type="password"]{ width:100%; padding:10px 12px; border-radius:8px; border:1px solid rgba(17,24,39,0.12); background:#fff; box-sizing:border-box; margin-bottom:14px; font-size:0.95rem; }
        ...
        .helper-links{ margin-top:12px; font-size:0.9rem; display:flex; justify-content:center; color:#374151; }
        .helper-links a{ color:#111827; text-decoration:underline; }
...
<body>
    <div class="login-wrapper">
        <main class="login-card" role="main">
            ...
            <p class="lead">Masukkan password baru Anda.</p>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="helper-links">
                    <a href="/login" style="color:#111827; text-decoration:underline;">Kembali ke Login</a>
                </div>
            </form>
        </main>
    </div>
